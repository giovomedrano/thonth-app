...
const App = () => {
  ...
  // const columns = [ { label: 'Name', field: 'name', width: 150, attributes: { 'aria-controls': 'DataTable', 'aria-label': 'Name', }, }, { label: 'Position', field: 'position', width: 270, }, { label: 'Office', field: 'office', width: 200, }, { label: 'Age', field: 'age', sort: 'asc', width: 100, }, { label: 'Start date', field: 'date', sort: 'disabled', width: 150, }, { label: 'Salary', field: 'salary', sort: 'disabled', width: 100, }]
  const columns = [ { "label": "Name", "field": "name", "sort": "asc", "width": 150 }, { "label": "Position", "field": "position", "sort": "asc", "width": 270 }, { "label": "Chain", "field": "chain", "sort": "asc", "width": 200 }, { "label": "Age", "field": "age", "sort": "asc", "width": 100 }, { "label": "ATH Date", "field": "date", "sort": "asc", "width": 150 }, { "label": "Price", "field": "price", "sort": "desc", "width": 100 } ]
